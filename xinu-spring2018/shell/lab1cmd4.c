/**
  ...
  * It takes two integers and divided them
  * The command has been assign into the cmd table using keywork "divided"
  * TO use it, the correct format should be:"
  * divided digitValue1 digitValue2"
...
#include <string.h>
#include <ctype.h>
shellcmd lab1cmd4(int argc, char *argv[]) {
    // check if argument number is correct
    if (argc != 3) {
        printf("please use \"divided val1 val2 \"\n");
        return -1;
    }
